...
const Products = () => {
  ...
  return (
    <>
      ...
      <Helmet>
        <meta charSet="utf-8" />
        <title>Green Era | Products</title>
      </Helmet>
            ...
            <div className="Products_des">
              ...
              <div className="Products_desc_main">
                <p className="Products_desc">
                  A tarpaulin is a large sheet of waterproof material available
                  in various sizes, usually made from plastic like HDPE, LDPE or
                  PVC. In the olden days, they were used to cover objects on
                  ships from where it gets its name – tar + palling meaning a
                  “tarred canvas”. There are various types of tarpaulins
                  available in different materials and thicknesses for various
                  types of applications, e.g., canvas, urethane-coated
                  polyester, polyethylene, etc. Modern day tarpaulins are made
                  from woven polyethylene, at the corners and along the edges at
                  regular intervals which are used to pass nylon ropes through
                  them so that they can be tied to an anchor. The main use of
                  tarpaulins is to provide shelter from rains and in some cases,
                  even from sun and winds.
                </p>
            ...
            <div className="Products_des">
              ...
              <div className="Products_desc_main">
                <p className="Products_desc">
                  ...
                  this plastic film makes it more durable, flexible, and
                  demanding than other films of similar weights and thickness.
                  This multilayer cross laminated tarpaulin material is both
                  durable and flexible. We are the leading maker of multilayer
            ...
            <div className="Products_des">
              ...
              <div>
                <p className="Products_desc">
                  ...
                  safeguard our plants and things. It is a versatile network
                  with numerous uses. Green Net is used to cultivate crops in
                ...
                <p className="Products_desc">
                  ...
                  and climate control in a variety of applications. Greenera
                  Shade Nets, made with high-quality materials and innovative
                  weaving processes, provide durability, lifespan, and
                  adaptability to meet a wide range of shade needs.
                </p>
                <br />
                <br />
                ...
                <div
                  ...
                  <div className="pro_list_main">
                    ...
                    <p className="Products_desc">
                      ...
                      Engineered with UV stabilizers, Greenera Shade Nets
                      provide superior protection against harmful ultraviolet
                      radiation, ensuring prolonged durability and extending the
                      net's lifespan.
                    </p>
                  </div>
                  <div className="pro_list_main">
                    ...
                    <p className="Products_desc">
                      ...
                      high-density polyethylene (HDPE) material. It is
                      anti-aging, strong, and durable.
                    </p>
                  </div>
                  <div className="pro_list_main">
                    <div className="tick_inner_main">
                  ...
                  <div className="pro_list_main">
                    ...
                    <p className="Products_desc">
                      ...
                      These shade nets regulate light intensity, temperature,
                      and humidity levels, creating an optimal environment for
                      plant growth. They protect crops from excessive sunlight,
                      heat, and adverse weather conditions, promoting healthier
            ...
            <div className="Products_des">
              ...
              <div>
                <p className="Products_desc">
                  ...
                  processes offer long-term durability and dependability. Our
                  pond liner is engineered to offer seamless waterproofing,
                  successfully preventing leakage and seepage while preserving
                  water levels and quality. It is UV stabilized, so it can
                  survive continuous sunshine exposure without losing structural
                  ...
                  any lining project. Our pond liner is resistant to chemicals
                  and rips, ensuring long-lasting performance even in harsh
                  conditions.
                </p>
              </div>
            </div>
            ...
            <div className="Products_des">
              ...
              <div>
                ...
                <p className="Products_desc">
                  ...
                  plastic bags, shrink wraps, and containers due to its
                  excellent resistance to moisture, chemicals, and impact. It is
                  also commonly used in the production of squeeze bottles,
                  tubing, and various household items.
                </p>
                <br />
                <p className="Products_desc">
                  ...
                  friendly than some other types of plastics due to its slow
                  rate of biodegradation. However, efforts are being made to
                  improve recycling methods and develop more sustainable
                  alternatives to mitigate its environmental impact.
                </p>
              </div>
            </div>
            <div className="Products_image_main">
            ...
            <div className="Products_des">
              ...
              <div>
                <p className="Products_desc">
                  ...
                  vermicompost. This technique is referred to as
                  vermicomposting. Earthworms devour this waste as food and
                  degrade it, which eventually turns into organic compost. This
                  is often referred to as worm composting. Vermi beds are the
                  future of current composting technology. Vermi Beds are an
                  excellent solution for organic agriculture growers seeking
                  higher-quality crop harvests.
                </p>
                <br />
                <p className="Products_desc">
                  Greenera HDPE Vermi beds are made of superior HDPE woven
                  laminated textiles, are ISI-certified for quality assurance,
                  and UV-resistant for durability. They have a net window for
          ...
          <div className="Products_des2_main" id="Mulch_Film">
            <div className="Products_des">
              ...
              <div>
                ...
                <br />
                <p className="Products_desc">
                  Greenera Mulch Film is a high-quality product made from
                  premium LLDPE and LDPE materials supplemented with additives.
                  It stands out as a protective layer for soil surfaces,
                  enhancing growing conditions and crop yields. With its
                  remarkable moisture retention, weed suppression, and soil
                  temperature management, it produces an optimal environment for
                  plant development, distinguishing it from other mulch films on
                  the market.
                </p>
              </div>
            </div>
            ...
            <div className="Products_des">
              ...
              <div>
                <p className="Products_desc">
                  ...
                  traditional plastic bags, helping to mitigate plastic
